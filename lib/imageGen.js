...
function buildHTML(carrier, trackingNumber) {
  ...
  const accent      = isEMS ? '#C62828' : '#E65100';
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  /* Header */
  .header{
    background:linear-gradient(135deg,#0D1B6E 0%,#1A3A8F 60%,#2756C5 100%);
    padding:20px 24px 16px;
    display:flex;
    align-items:center;
    justify-content:space-between;
  }
  .shop-name{font-size:18px;font-weight:700;color:#fff}
  .shop-sub{font-size:11px;color:rgba(255,255,255,.65);margin-top:2px}
  .courier-badge{
    background:${accent};
    color:#fff;
    padding:5px 14px;
...
<div class="wrap">
  ...
  <div class="header">
    <div>
      ...
      <div class="shop-sub">CK Air Conditioner</div>
    </div>
